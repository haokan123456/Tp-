...
<body>
    ...
    <!-- /Sidebar Menu -->
            ...
            <div class="page-content">
                ...
                <!-- Page Body -->
                <div class="page-body">
                    <form role="form" class='form-horizontal' action="<?php echo url('edit'); ?>" method='POST'
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <div class="radio">
                                    <label>
                                        <input name="show_nav" type="radio" class="colored-blue" value="1" <?php if($cate['show_nav']==1): ?>checked<?php endif; ?>> <span class="text">显示</span>
                                    </label>
                                    <label>
                                        <input name="show_nav" type="radio" class="colored-blue" value='0' <?php if($cate['show_nav']==0): ?>checked<?php endif; ?>> <span class="text">隐藏</span>
                                    </label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea name="keywords" id="keywords" cols="30" rows="10"
                                    style='width: 100%;resize:none;'><?php echo $cate['keywords']; ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea name="description" id="description" cols="30" rows="10" class="form-control"
                                    style='resize:none;'><?php echo $cate['description']; ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
